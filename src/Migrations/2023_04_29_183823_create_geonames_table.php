...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::create('geonames', function (Blueprint $table) {
      ...
      $table->string('asciiname', 200)->nullable()->index();      // asciiname: name of geographical point in plain ascii characters, varchar(200)
      ...
      $table->decimal('longitude', 11, 8)->nullable()->index();   // longitude: longitude in decimal degrees (wgs84)
      $table->string('feature_class', 1)->nullable()->index();    // feature class: see http://www.geonames.org/export/codes.html, char(1)
      $table->string('feature_code', 10)->nullable();             // feature code: see http://www.geonames.org/export/codes.html, varchar(10)
      $table->string('country_code', 2)->nullable()->index();     // country code: ISO-3166 2-letter country code, 2 characters
