    ...
    public function up()
    {
        Schema::create('geonames_modifications', function (Blueprint $table) {
            ...
            $table->string('asciiname',
                200);           // asciiname         : name of geographical point in plain ascii characters, varchar(200)
            $table->string('alternatenames',
                10000);    // alternatenames    : alternatenames, comma separated, ascii names automatically transliterated, convenience attribute from alternatename table, varchar(10000)
            ...
            $table->string('feature_class',
                1);         // feature class     : see http://www.geonames.org/export/codes.html, char(1)
            $table->string('feature_code',
                10);         // feature code      : see http://www.geonames.org/export/codes.html, varchar(10)
            $table->string('country_code',
                2);          // country code      : ISO-3166 2-letter country code, 2 characters
            $table->string('cc2',
                200);                 // cc2               : alternate country codes, comma separated, ISO-3166 2-letter country code, 200 characters
            $table->string('admin1_code',
                20);          // admin1 code       : fipscode (subject to change to iso code), see exceptions below, see file admin1Codes.txt for display names of this code; varchar(20)
            $table->string('admin2_code',
                80);          // admin2 code       : code for the second administrative division, a county in the US, see file admin2Codes.txt; varchar(80)
            $table->string('admin3_code',
                20);          // admin3 code       : code for third level administrative division, varchar(20)
            $table->string('admin4_code',
                20);          // admin4 code       : code for fourth level administrative division, varchar(20)
            ...
            $table->string('timezone',
                40);             // timezone          : the iana timezone id (see file timeZone.txt) varchar(40)
